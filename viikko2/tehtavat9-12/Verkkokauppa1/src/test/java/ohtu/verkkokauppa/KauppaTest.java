...
public class KauppaTest {
    ...
    public void kahdenOstoksenPaaytyttyaPankinMetodiaTilisiirtoKutsutaan() {
        ...
        when(varasto.haeTuote(2)).thenReturn(new Tuote(2, "börsta", 15));
    ...
    @Test
    public void kahdenOstoksenPaaytyttyaPankinMetodiaTilisiirtoKutsutaanKunToinenOnLoppu() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
    ...
    public void varmistaNollaus() {
        ...
        k.lisaaKoriin(1);     // ostetaan tuotetta numero 1 eli maitoa
        k.lisaaKoriin(2);
        k.tilimaksu("ari", "11111");
        
        verify(pankki).tilisiirto(eq("ari"), eq(42), eq("11111"), eq("33333-44455"), eq(20));
    ...
    @Test
    public void varmistaJuoksevaViite() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
        ...
        verify(pankki).tilisiirto(eq("ari"), eq(1), eq("11111"), eq("33333-44455"), eq(20));
    ...
    @Test
    public void varmistaTuotteenPoistaminenKorista() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
        ...
        verify(pankki).tilisiirto(eq("ari"), eq(42), eq("11111"), eq("33333-44455"), eq(5));
    }
}
